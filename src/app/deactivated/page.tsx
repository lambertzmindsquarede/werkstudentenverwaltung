...
export default function DeactivatedPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-red-950 to-slate-900 p-4">
      ...
      <div className="relative w-full max-w-md">
        <Card className="border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl">
          <CardHeader className="text-center pb-2 pt-8">
            ...
            <CardTitle className="text-xl font-semibold text-white">Konto deaktiviert</CardTitle>
            <CardDescription className="text-slate-400 text-sm mt-2 leading-relaxed">
              Dein Konto wurde von einem Administrator deaktiviert und hat keinen Zugang mehr zur
              App.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-8 pt-4">
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
              <p className="text-slate-300 text-sm text-center">
                Wende dich an deinen Vorgesetzten oder die IT, falls du glaubst, dass dies ein
                Fehler ist.
              </p>
            </div>
